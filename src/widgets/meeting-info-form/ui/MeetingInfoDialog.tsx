...
const MEETING_INFO_FORM_ID = 'meeting-info-form';

/** 회의 이름·목표 시간·목적·비고를 입력하는 모달. 생성과 수정에서 함께 쓴다. */
export const MeetingInfoDialog = ({
  ...
  const [isFormValid, setIsFormValid] = useState(() => isCreateMeetingFormValid(initialValues));
